    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/static/smarteditor/sample/photo_uploader/file_uploader_html5.jsp'; 	//upload URL
...
// 	        sCallback : location.href.replace(/\/[^\/]*$/, '') + '/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
 	    	sUrl : '/static/smarteditor/sample/photo_uploader/file_uploader.jsp'
 	    	sCallback : '/static/smarteditor/sample/photo_uploader/popup/callback.html'
